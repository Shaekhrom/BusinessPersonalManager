    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonGuardarCambiosGestionarPuntuacion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Puntuacion.insertarPuntuacionEnBaseDeDatos(puntuacionAInsertar,Estatica.getUsuarioEstatico().getIdEmpresa() , new PuntuacionInsertCallback() {
                    @Override
                    public void onCompleted(boolean success) {
                        if (success) {
                            ...
                            Puntuacion.actualizarPuntuacionEnBaseDeDatos(puntuacionAInsertar,Estatica.getUsuarioEstatico().getIdEmpresa(), new PuntuacionUpdateCallback() {
                                @Override
                                public void onUpdateCompleted(boolean success) {
                                    if (success) {
                                        Usuario.actualizarPuntuacionPorEmail(email, puntuacion, new UsuarioUpdateCallback() {
